...
# Define paths
test_dir = '/home/orion/Geo/Projects/Transforming-1D-CNNs-to-2D-CNNs/k-fold cross validation/Reshaping Method/test' # Update this path to your test dataset
output_dir = '/home/orion/Geo/Projects/Transforming-1D-CNNs-to-2D-CNNs/k-fold cross validation/Reshaping Method/output/'  # Path where models are saved

...
def scale_to_grayscale_logarithmic(image_data):
...
def create_fft_image(ecg_data, target_shape=(224, 224)):
    ...
    grayscale_image = scale_to_grayscale_logarithmic(scaled_spectrum_2d)
...
output_folder = '/home/orion/Geo/Projects/Transforming-1D-CNNs-to-2D-CNNs/Dimension Transformation/Fast Fourier Transform (FFT)/FFT with Logarithmic Scaling/2D Images'
